...
# The personalities summary file (/proc/mdstat) must reflect the new
# personality and layout after takeover. This catches a class of bugs
# where the sysfs and the proc summary disagree.
. "$(dirname "$0")/lib.sh"
md_require_root
md_require_tools
md_require_modules
