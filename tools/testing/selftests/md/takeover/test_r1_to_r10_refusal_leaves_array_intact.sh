...
# and level_store() rolls back the new_* fields on failure. This
# test verifies the observable state.
. "$(dirname "$0")/lib.sh"
md_require_root
md_require_tools
md_require_modules
...
# write-mostly trips the write-mostly precondition, refusing the takeover.
